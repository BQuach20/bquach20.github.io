(function (window) {
    ...
    collectable.init = function (game) {
        ...
        collectable.create(type.db, 650, 100, 10, 1);
        collectable.create(type.max, 480, 10, 50, 1);
        collectable.create(type.grace, 650, 250, 6, 0.7);
        collectable.create(type.kennedi, 0, 600, 6, 0.7);
